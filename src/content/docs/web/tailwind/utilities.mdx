...
<p class="underline decoration-blue-500 decoration-2 decoration-wavy">
  Fancy underline
</p>
```
...
<p class="line-clamp-2">
  Text clamped to two lines. Lorem ipsum dolor sit amet...
</p>
...
<img
  class="grayscale-0 hover:grayscale transition-all"
  src="..."
  alt="Color on hover"
/>
...
```html
<div
  class="group relative overflow-hidden rounded-2xl bg-white shadow-md
            hover:shadow-xl transition-shadow duration-300 cursor-pointer"
>
  <img
    class="w-full aspect-video object-cover group-hover:scale-105
